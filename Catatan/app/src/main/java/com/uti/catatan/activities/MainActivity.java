...
import com.uti.catatan.adapter.DataAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<ModelKegiatan> dataKegiatan = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler.setAdapter(new DataAdapter(MainActivity.this, dataKegiatan));
    ...
    private void setData() {
        dataKegiatan = helper.tampilDataKegiatan();
        if (dataKegiatan.size() == 0) {
